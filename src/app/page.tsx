  ...
  return (
   <div id="main">
    ...
    <div className="mainwordstwo">
      ...
      <img className="icon" src="https://i.ibb.co/4FdMwHs/Twitter.png"></img>
      <img className="icon" src="https://i.ibb.co/1sX8YPw/Mastodon.png"></img>
      <img className="icon" src="https://i.ibb.co/hmJ1kLq/Discord.png"></img>
      <img className="icon" src="https://i.ibb.co/RjbNQsL/Threads.png"></img>
      </div>
